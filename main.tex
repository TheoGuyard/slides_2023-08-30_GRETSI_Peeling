...
\date{\scriptsize{$^{\star}$SIMSMART, Inria, France \\ $^{\dagger}$ICTEAM, UCLouvain, Belgium \\ $^{\ddagger}$IETR, CentraleSupelec, France}}
\author{\textbf{Th\'{e}o Guyard}${}^{\star}$, Gilles Monnoyer$^{\dagger}$, C\'{e}dric Herzet${}^{\star}$ and Cl\'{e}ment Elvira$^{\ddagger}$}
\institute{GRETSI - Colloque Francophone
de Traitement du Signal et des Images \\ Grenoble, France \\ 2023}
